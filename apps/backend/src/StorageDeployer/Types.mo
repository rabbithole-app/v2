...
module {
  ...
  // -- Frontend Pull Protocol (wire types shared with the storage canister) --

  public type FrontendPullError = FrontendPullTypes.PullError;
  public type FrontendPullPlan = FrontendPullTypes.PullPlan;
  public type FrontendPullStats = FrontendPullTypes.PullStats;
  public type FrontendPullResult = FrontendPullTypes.PullResult;
  ...
  public type UnifiedTaskType = {
    ...
    /// Ask the storage canister to pull its frontend from this backend.
    /// The push-model task family (#FrontendCreateBatch/#FrontendUploadChunks/
    /// #FrontendCommitBatch/#RevokeInstallerPermission) was removed via
    /// PullMigration — the stable queue is rebuilt with this type on upgrade.
    #FrontendStartPull : { canisterId : Principal };
  };
