...
module {
  ...
  public type FieldsDisplay = { fields : [(Text, Icrc21Value)]; intent : Text };
  ...
  public type TipOfChainRes = { certification : ?Blob; tip_index : BlockIndex };
  ...
  public type Self = actor {
    ...
    get_allowances : shared query GetAllowancesArgs -> async Allowances;
    ...
    remove_approval : shared RemoveApprovalArgs -> async ApproveResult;
