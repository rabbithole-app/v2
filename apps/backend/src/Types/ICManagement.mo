...
module {
  ...
  public type bitcoin_block_hash = Blob;
  public type bitcoin_block_header = Blob;
  public type bitcoin_block_height = Nat32;
  ...
  public type bitcoin_get_block_headers_args = {
    start_height : bitcoin_block_height;
    end_height : ?bitcoin_block_height;
    network : bitcoin_network;
  };
  public type bitcoin_get_block_headers_result = {
  ...
  public type canister_metadata_args = {
    name : Text;
    canister_id : canister_id;
  };
  public type canister_metadata_result = { value : Blob };
  ...
  public type change_origin = {
    ...
    #from_canister : { canister_version : ?Nat64; canister_id : canister_id };
  };
  ...
  public type delete_canister_snapshot_args = {
    canister_id : canister_id;
    snapshot_id : snapshot_id;
  };
  ...
  public type environment_variable = { value : Text; name : Text };
  ...
  public type list_canister_snapshots_args = { canister_id : canister_id };
  public type list_canister_snapshots_result = [snapshot];
  public type load_canister_snapshot_args = {
    canister_id : canister_id;
    sender_canister_version : ?Nat64;
    snapshot_id : snapshot_id;
  };
  ...
  public type read_canister_snapshot_data_args = {
    kind : {
  ...
  public type read_canister_snapshot_data_response = { chunk : Blob };
  public type read_canister_snapshot_metadata_args = {
    canister_id : canister_id;
    snapshot_id : snapshot_id;
  };
  public type read_canister_snapshot_metadata_response = {
    globals : [
      { #f32 : Int32; #f64 : Int64; #i32 : Int32; #i64 : Int64; #v128 : Nat }
    ];
    canister_version : Nat64;
    source : { #metadata_upload : Any; #taken_from_canister : Any };
    certified_data : Blob;
  ...
  public type subnet_info_args = { subnet_id : Principal };
  public type subnet_info_result = {
    replica_version : Text;
    registry_version : Nat64;
  };
  public type take_canister_snapshot_args = {
    replace_snapshot : ?snapshot_id;
    canister_id : canister_id;
    uninstall_code : ?Bool;
    sender_canister_version : ?Nat64;
  };
  public type take_canister_snapshot_result = snapshot;
  ...
  public type upload_canister_snapshot_data_args = {
    chunk : Blob;
    kind : {
  ...
  public type upload_canister_snapshot_metadata_args = {
    globals : [
      { #f32 : Int32; #f64 : Int64; #i32 : Int32; #i64 : Int64; #v128 : Nat }
    ];
    replace_snapshot : ?snapshot_id;
  ...
  public type upload_canister_snapshot_metadata_response = {
    snapshot_id : snapshot_id;
  };
  public type upload_chunk_args = { chunk : Blob; canister_id : canister_id };
  ...
  public type Self = actor {
    ...
    bitcoin_get_block_headers : shared bitcoin_get_block_headers_args -> async bitcoin_get_block_headers_result;
    ...
    canister_metadata : shared canister_metadata_args -> async canister_metadata_result;
    ...
    delete_canister_snapshot : shared delete_canister_snapshot_args -> async ();
    ...
    list_canister_snapshots : shared list_canister_snapshots_args -> async list_canister_snapshots_result;
    load_canister_snapshot : shared load_canister_snapshot_args -> async ();
    /// metrics interface
    ...
    read_canister_snapshot_data : shared read_canister_snapshot_data_args -> async read_canister_snapshot_data_response;
    read_canister_snapshot_metadata : shared read_canister_snapshot_metadata_args -> async read_canister_snapshot_metadata_response;
    ...
    /// subnet info
    subnet_info : shared subnet_info_args -> async subnet_info_result;
    /// Canister snapshots
    take_canister_snapshot : shared take_canister_snapshot_args -> async take_canister_snapshot_result;
    uninstall_code : shared uninstall_code_args -> async ();
    update_settings : shared update_settings_args -> async ();
    upload_canister_snapshot_data : shared upload_canister_snapshot_data_args -> async ();
    upload_canister_snapshot_metadata : shared upload_canister_snapshot_metadata_args -> async upload_canister_snapshot_metadata_response;
