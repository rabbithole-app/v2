export const idlFactory = ({ IDL }) => {
  ...
  const ICPayWebhooksExample = IDL.Service({
    'getLastEventType' : IDL.Func([], [IDL.Opt(IDL.Text)], ['query']),
    'getLastPaymentId' : IDL.Func([], [IDL.Opt(IDL.Text)], ['query']),
  ...
  return ICPayWebhooksExample;
};
export const init = ({ IDL }) => { return [IDL.Vec(IDL.Nat8)]; };
