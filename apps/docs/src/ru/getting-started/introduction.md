...
Rabbithole — децентрализованное файловое хранилище на [Internet Computer](https://internetcomputer.org/). В отличие от традиционных зашифрованных хранилищ, Rabbithole не просит вас доверять компании. Он заменяет доверие **верифицируемыми криптографическими гарантиями**.
...
3. Загружаете файл — он **шифруется в браузере** ключами, вычисленными через vetKeys
4. Зашифрованные фрагменты сохраняются в **вашей персональной канистре**
5. При скачивании фрагменты загружаются и **расшифровываются локально**
