...
Без шифрования Rabbithole всё ещё применяет владение и правила доступа, но
инфраструктура хранения может видеть содержимое файла.
...
Сначала важно отделить режимы хранения: шифрование добавляет
конфиденциальность содержимого, но контроль доступа и проверка целостности
остаются важными в обоих режимах.
...
Ниже показано, какие угрозы закрываются полностью, частично или только в
