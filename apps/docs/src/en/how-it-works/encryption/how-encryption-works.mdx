...
- A user who already downloaded and decrypted a file may keep their copy after
  access is revoked.
- Plaintext mode does not provide these confidentiality guarantees.
