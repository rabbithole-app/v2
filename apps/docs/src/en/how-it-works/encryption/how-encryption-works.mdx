...
[Encryption](/how-it-works/encryption/index). For the key-service choice, read
...
Read [File integrity](/how-it-works/storage/integrity) for the storage-side
verification model.
...
[Trust Model](/how-it-works/trust-model).
