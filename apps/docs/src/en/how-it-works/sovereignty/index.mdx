...
itself belongs to you: you can open it directly, fund it with cycles, and decide
whether to accept future updates.
...
- **Cycle funding**: you can keep the storage running with Rabbithole Pro or
...
means Rabbithole becomes a service layer around infrastructure that you control.

Rabbithole can still provide:

- the main app interface at `rabbithole.app`;
- storage creation and initial setup;
- optional code and frontend asset updates;
- Pro top-ups that keep the cycle balance funded automatically;
