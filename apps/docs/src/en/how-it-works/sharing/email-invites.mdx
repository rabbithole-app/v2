...
[Identity Attribute](/en/how-it-works/authentication#trust-verified-attributes) that helps Rabbithole
...
:::note{title="Which emails are verified today"}
...
:::details{title="Technical view: email commitments and pending grants"}
...
- [Authentication and identity attributes](/en/how-it-works/authentication#trust-verified-attributes)
- [Permission model](/en/how-it-works/sharing/permissions)
- [Encrypted sharing](/en/how-it-works/sharing/encryption-in-shared-access)
