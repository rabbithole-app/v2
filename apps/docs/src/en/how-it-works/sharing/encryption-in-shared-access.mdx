...
the request before key derivation.
...
Email invites work for encrypted files in the same way. The invite can wait
...
:::note What changes without active Pro

Starter Vault keeps the owner's personal encrypted storage available within
issued limits, but invited users can request keys only while the owner has
active Pro. Durable access and recovery access are separate sovereign
scenarios described in the permission model.
...
- [How encryption works](/how-it-works/encryption/index)
- [Keys and vetKeys](/how-it-works/encryption/vetkeys)
- [Permission model](/how-it-works/sharing/permissions)
- [Storage modes](/how-it-works/storage/index)
