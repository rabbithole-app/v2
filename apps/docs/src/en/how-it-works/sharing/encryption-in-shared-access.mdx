...
Storage license keeps the owner's personal encrypted storage available, but
invited users can request keys only while the owner has active Pro. Durable
access and recovery access are separate sovereign scenarios described in the
permission model.
