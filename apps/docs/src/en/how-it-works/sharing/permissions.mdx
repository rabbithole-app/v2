...
:::note{title="Shared access and Pro"}

Shared access and access management require the storage owner to have active Pro.
Storage license keeps the owner's personal encrypted storage available, but it
does not keep shared access active after Pro expires.
