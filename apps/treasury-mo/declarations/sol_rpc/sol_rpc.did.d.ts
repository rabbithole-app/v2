...
export interface TransactionStatusMeta {
   ...
   * after the transaction was processed or `null` if token balance recording was not yet
  ...
  'rewards' : [] | [Array<Reward>],
  /**
   * Array of log messages or `null` if log message recording was not enabled during this transaction.
   */
  ...
  /**
   * List of [token balances](https://solana.com/de/docs/rpc/json-structures#token-balances) from
   * before the transaction was processed or `null` if token balance recording was not yet
   * enabled during this transaction.
   */
