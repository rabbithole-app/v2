...
export interface CreateBatchResponse__1 {
  batch_id: BatchId;
}
...
export interface CreateChunkResponse__1 {
  chunk_id: bigint;
}
...
export interface EncryptedStorageCanister {
  ...
  >;
  createAssetChunks: ActorMethod<[CreateChunksArguments], CreateChunksResponse>;
  ...
  listPermitted: ActorMethod<[[] | [Entry]], Array<[Principal, PermissionExt]>>;
