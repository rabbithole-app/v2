export const idlFactory = ({ IDL }) => {
  ...
  const JsonRequestResult = IDL.Variant({ 'Ok' : IDL.Text, 'Err' : RpcError });
  const MultiJsonRequestResult = IDL.Variant({
    'Consistent' : JsonRequestResult,
    'Inconsistent' : IDL.Vec(IDL.Tuple(RpcService, JsonRequestResult)),
  });
  ...
  return IDL.Service({
    ...
    'eth_feeHistoryCyclesCost' : IDL.Func(
        [RpcServices, IDL.Opt(RpcConfig), FeeHistoryArgs],
        [RequestCostResult],
        ['query'],
      ),
    ...
    'eth_getBlockByNumberCyclesCost' : IDL.Func(
        [RpcServices, IDL.Opt(RpcConfig), BlockTag],
        [RequestCostResult],
        ['query'],
      ),
    ...
    'eth_getLogsCyclesCost' : IDL.Func(
        [RpcServices, IDL.Opt(GetLogsRpcConfig), GetLogsArgs],
        [RequestCostResult],
        ['query'],
      ),
    ...
    'eth_getTransactionCountCyclesCost' : IDL.Func(
        [RpcServices, IDL.Opt(RpcConfig), GetTransactionCountArgs],
        [RequestCostResult],
        ['query'],
      ),
    ...
    'eth_getTransactionReceiptCyclesCost' : IDL.Func(
        [RpcServices, IDL.Opt(RpcConfig), IDL.Text],
        [RequestCostResult],
        ['query'],
      ),
    ...
    'eth_sendRawTransactionCyclesCost' : IDL.Func(
        [RpcServices, IDL.Opt(RpcConfig), IDL.Text],
        [RequestCostResult],
        ['query'],
      ),
    ...
    'multi_requestCyclesCost' : IDL.Func(
        [RpcServices, IDL.Opt(RpcConfig), IDL.Text],
        [RequestCostResult],
        ['query'],
      ),
